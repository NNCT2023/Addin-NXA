...
| 🏷️ Trường hợp                     | 📝 Mô tả                                                                 | 💡 Cú pháp hàm                                                                 | 📊 Kết quả                              |
|----------------------------------|-------------------------------------------------------------------------|-------------------------------------------------------------------------------|----------------------------------------|
| 🖼️ Tự động căn chỉnh mã QR       | Chèn mã QR thanh toán, tự động căn chỉnh kích thước vừa ô.              | `=NNCT_IMAGE(NNCT_QR_Bank("Vietcombank", "1234567890", "Nguyen Van A", 100000, "Thanh toan hoa don")`) | Mã QR tự động vừa ô                    |
| 📏 Tùy chỉnh kích thước mã QR     | Chèn mã QR thanh toán với kích thước 300x300 pixel.                     | `=NNCT_IMAGE(NNCT_QR_Bank("Vietcombank", "1234567890", "Nguyen Van A", 100000, "Thanh toan hoa don")`, FALSE, 300, 300) | Mã QR kích thước 300x300 pixel         |
